# Django settings for bhavans_world project.
import os
...
#CACHE_BACKEND = "django_couchdb_utils.cache.couch://"
...
LOGIN_URL="/openid/"
PROFILE_PIC_UPLOAD_PATH=os.path.join(os.path.dirname(__file__),"site_media/profile_pics/")
